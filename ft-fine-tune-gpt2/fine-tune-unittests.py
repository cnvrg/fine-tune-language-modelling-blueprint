...
class TestFT(unittest.TestCase):   
    ...
    def test_outputdir_exist(self):
        ...
        scripts_dir = pl.Path(__file__).parent.resolve()
        file = pl.Path(os.path.join(scripts_dir, 'story_generator_checkpoint_' + 'gpt2'))
    ...
    def test_return_metrics(self):
        ...
        cmd = "python -u " + finetune_path + " --model_name gpt2 " \
        ...
        self.assertLess(float(perplexity), gpt2_target, message)
